...
- **Remesas SEPA (fichero bancario)** _(propuesta 2026-06-22 — siguiente a implementar)_: generar el **XML de adeudos directos SEPA** (pain.008, esquemas CORE/B2B; cuadernos AEB 19.14/34.14) para que el operador lo suba a su banco. Evita las comisiones de Stripe: el operador domicilia directamente. Requiere mandatos SEPA por cliente (IBAN + referencia de mandato + fecha de firma) y agrupar las facturas pendientes domiciliadas en una remesa con su fecha de cobro. Es la palanca de cobro de mayor ROI para el mercado español.
